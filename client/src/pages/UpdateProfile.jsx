...
// import { Save, Loader2, X, ImagePlus, Info } from 'lucide-react';
...
//     if (form.photos.length + existingPhotos.length + newFiles.length > 9) {
//       alert("You can upload a maximum of 9 photos.");
//       return;
//     }
//     setForm(prev => ({
//       ...prev,
...
//             className="p-4 rounded-xl border border-pink-300 bg-white/60 focus:outline-none focus:ring-2 focus:ring-pink-400"
//           />
//           <input
//             type="text"
