...
//           console.log("API returned null/empty data. Getting user data from localStorage...");
...
//           <span className="hidden md:inline font-semibold">ManageAllUsers</span>
//         </Link>
...
//     aria-label="Set up or edit your profile"
//   >
//     <IdentificationIcon className="w-6 h-6 text-green-300" />
//     <span className="hidden md:inline font-semibold">ReportedUsers</span>
//   </Link>
// </li>
