...
//       }
//       setComments((prev) =>
//         prev.map((c) => (c._id === id ? { ...c, approved: !isApproved } : c))
//       );
//     } catch (err) {
//       console.error(err);
...
//   if (loading) return <div className="text-center py-5">Loading comments...</div>;
...
//                   <td className="p-2">
//                     <div>{comment.userDetails?.name || "Anonymous"}</div>
//                   </td>
//                   <td className="p-2 max-w-xs truncate">{comment.comment}</td>
//                   <td className="p-2">{renderStars(comment.rating)}</td>
//                   <td className="p-2">
//                     <img
//                       src={
//                         comment.userProfileDetails?.profileImages?.[0]
//                           ? `http://127.0.0.1:4000/uploads/profile/${comment.userProfileDetails.profileImages[0]}`
...
//                         {comment.approved ? "Enabled" : "Disabled"}
//                       </span>
//                     </label>
//                   </td>
//                 </tr>
