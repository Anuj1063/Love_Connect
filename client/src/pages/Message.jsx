...
// import { Search, Heart, MessageCircle, Loader2, User, Sparkles, Filter } from 'lucide-react';
...
//     console.log('🧠 Selected match for messaging:', match);
...
//           <Heart className="text-red-500 w-8 h-8 mx-auto mb-4" />
//           <p className="text-gray-800 font-bold mb-2">Oops!</p>
//           <p className="text-sm text-gray-600 mb-4">{error}</p>
//           <button
//             onClick={fetchMatches}
//             className="px-4 py-2 bg-pink-500 text-white rounded-lg hover:scale-105"
//           >
//             Try Again
//           </button>
//         </div>
...
//       {/* Header */}
// <div className="sticky top-0 bg-white/90 backdrop-blur-lg shadow z-10 px-4 py-3">
//   <div className="flex items-center justify-between">
//     <div className="flex gap-2 items-center">
//       <Heart className="text-pink-500 w-5 h-5" />
//       <h1 className="text-lg font-semibold text-pink-600">Your Matches</h1>
//     </div>
//     <div className="flex gap-1 items-center text-pink-600 text-sm font-medium">
...
//       className="w-full pl-10 pr-3 py-1.5 text-sm bg-white rounded-lg border border-gray-200 shadow-sm focus:outline-none focus:ring-1 focus:ring-pink-400"
//     />
//   </div>
// </div>
...
//       <p className="text-base font-medium text-gray-700">No matches found</p>
//     </div>
//   ) : (
...
//             />
//           ) : (
//             <div className="h-full flex items-center justify-center bg-pink-100">
...
//             <div>
//               <p className="font-semibold text-sm text-gray-800">{match.name}</p>
//               {/* <p className="font-semibold text-sm text-gray-800">{match.userId}</p> */}
//               <p className="text-xs text-gray-500">
//                 {match.age ? `${match.age} yrs` : 'Age N/A'}
//               </p>
//             </div>
//             <MessageCircle className="text-pink-500 w-4 h-4" />
//            <Link to={`/chat/${match.userId}`}>
//            <button className='btn btn-primary'>chat</button>
//            </Link> 
//           </div>
//           <p className="text-xs text-gray-600 line-clamp-2">{match.bio}</p>
//         </div>
//       </div>
//     ))
//   )}
