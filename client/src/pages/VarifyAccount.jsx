...
const VerifyAccount = () => {
  ...
  return (
    <div className="min-h-screen relative flex flex-col lg:flex-row overflow-y-auto">
      {/* Background */}
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1578641214267-c33356f49df2?w=600&auto=format&fit=crop&q=60"
          alt="Verification background"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/50 via-black/30 to-black/70"></div>
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white/95 backdrop-blur-lg rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 text-center max-w-sm sm:max-w-md mx-4 animate-bounce">
            <div className="w-20 h-20 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-2xl">
              <CheckCircle className="w-10 h-10 text-white" />
            </div>
            <h3 className="text-2xl font-bold text-gray-800 mb-2">
      ...
      {/* Left Panel */}
      <div className="relative z-10 flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-16">
        <div className="max-w-md sm:max-w-lg text-center lg:text-left">
          <div className="flex items-center justify-center lg:justify-start mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl shadow-2xl">
              <Shield className="w-8 h-8 sm:w-10 sm:h-10 text-white animate-pulse" />
            </div>
            <div className="ml-4">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed mt-6 drop-shadow-lg">
            We've sent a secure verification code to your email. Enter it below
            to activate your account and start your journey to finding love.
          </p>
      ...
      <div className="relative z-10 w-full lg:w-2/5 xl:w-1/3 flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-sm sm:max-w-md">
          ...
          {/* Form Box */}
          <div className="bg-white/15 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 hover:bg-white/20 transition-all duration-500">
            <div className="space-y-6">
              {/* Email Input */}
              <div>
                <label className="text-sm font-semibold text-white/95 tracking-wide">
                ...
                <input
                  ...
                  className={`w-full pl-4 pr-4 py-3 sm:py-4 bg-white/10 border rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-300 focus:bg-white/20 transition text-white placeholder-white/50 backdrop-blur-sm ${
                    errors.email ? "border-red-400/50" : "border-white/20"
                  } ${cameFromRegistration ? "opacity-75" : ""}`}
                />
                {errors.email && (
              ...
              <div className="text-center">
                <div
                  className={`inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 rounded-2xl border backdrop-blur-sm text-sm ${
                    isExpired
                      ? "bg-red-500/20 border-red-400/30 text-red-200"
                      : timeLeft <= 30
                      ? "bg-orange-500/20 border-orange-400/30 text-orange-200"
              ...
              {/* OTP Input */}
              <div>
                <label className="block text-sm font-semibold text-white/95 text-center">
                  Enter 4-Digit Code
                </label>
                <div className="flex justify-center space-x-3 mt-3">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      onChange={(e) => handleOtpChange(index, e.target.value)}
                      onKeyDown={(e) => handleKeyDown(index, e)}
                      className={`w-12 h-12 sm:w-14 sm:h-14 text-xl sm:text-2xl text-center font-bold bg-white/10 border-2 rounded-2xl focus:border-emerald-400 focus:bg-white/20 focus:outline-none transition text-white ${
                        errors.otp ? "border-red-400/50" : "border-white/20"
                      } ${isExpired ? "opacity-50" : ""}`}
                      disabled={isExpired}
                    />
                ...
                {errors.otp && (
                  <p className="text-sm text-red-300 mt-2 text-center flex items-center justify-center gap-2">
                    <AlertCircle className="w-4 h-4" />
                    {errors.otp}
                  </p>
                )}
              ...
              <button
                onClick={handleVerify}
                disabled={loading || isExpired}
                className="w-full py-4 rounded-2xl font-bold bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 text-white shadow-lg hover:shadow-2xl transition transform hover:scale-105 disabled:opacity-50"
              >
              ...
              <div className="text-center">
                ...
                <button
                  onClick={handleResendOtp}
                  disabled={resending || (!isExpired && timeLeft > 60)}
                  className="text-emerald-300 hover:underline disabled:opacity-50 text-sm mt-1"
                >
