...
//     {
//       id: 1,
//       text: "Amazing app! Met my partner here 6 months ago and we're still going strong. Highly recommend!",
//       name: "Michael R.",
//       initial: "M",
//       rating: 5,
...
//     {
//       id: 2,
//       text: "Found my soulmate within a week! This app changed my life completely. The matching algorithm is incredible.",
//       name: "Sarah M.",
//       initial: "S",
//       rating: 5,
...
//     {
//       id: 3,
//       text: "Best dating app I've ever used. Real people,  and amazing features. Love it!",
//       name: "David L.",
//       initial: "D",
//       rating: 5,
...
//     {
//       id: 4,
//       text: "Met so many wonderful people here. The interface is   easy to use. Definitely worth it!",
//       name: "Emma K.",
//       initial: "E",
//       rating: 5,
...
//     {
//       id: 5,
//       text: "Safe, secure, and effective. Found my perfect match after just 2 weeks. Thank you LoveConnect!",
//       name: "Alex T.",
//       initial: "A",
//       rating: 5,
...
//         setErrors({ submit: "Unable to connect to server. Please check if the server is running." })
//       } else {
...
//               Connect with amazing people who share your interests. Build meaningful relationships and find your perfect
//               companion.
//             </p>
...
//             {/* Testimonial Slider */}
//             <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 mt-8 relative overflow-hidden">
...
//       </div>
      ...
      //       <form onSubmit={handleSubmit} className="bg-white/15 backdrop-blur-2xl rounded-3xl p-8 shadow-2xl border border-white/20 space-y-6">
      //         {/* Name Field */}
...
//         <div className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-gradient-to-br from-pink-400/10 to-purple-400/10 rounded-full blur-2xl animate-pulse delay-1000"></div>
